...
print(f"{num1:0>10}")  # Completará com zeros à direita até completar 10 caracteres
print(f"{num2:0^10}")  # Colocará num2 no centro com zeros "em volta" até completar 10 caracteres
print(f"{num1 + num2:0<10}")  # Completará com zeros à esquerda até completar 10 caracteres
